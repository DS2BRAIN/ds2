def getContentCancelUserPlanEn(name):
...
Account has been disabled after 15 failed payment attempts. Please update your payment information to continue your service. </p>
</div>
</div>
