    ...
    api
      ...
      .then((res) => {
        ...
        dispatch(
          openSuccessSnackbarRequestAction(
            t(
              "Creating Custom AI. You will be notified via email when completed."
            )
          )
        );
    ...
    >
      <div className={classes.autoLabelingContent}>
        <div>
            ...
            labelprojects.projectDetail.workapp !== "normal_regression" && (
              <>
                ...
                <span className={classes.subHighlightText}>
                  *{" "}
                  {t(
                    "Only classes with at least 10 labeled data can be selected."
                  )}
                </span>
                <div style={{ maxHeight: 200, overflowY: "auto" }}>
                  <FormControl
          ...
          >
            {t(
              "Create a custom AI based on the training data labeled so far. You can proceed with auto-labeling with the created AI."
            )}
          </Typography>
        </div>
                ...
                <Tooltip
                  title={
                    <span style={{ fontSize: "11px" }}>
                      {t(
                        "You must have at least 10 labels per class to create a Custom AI."
                      )}
                    </span>
                  }
                  placement="top"
