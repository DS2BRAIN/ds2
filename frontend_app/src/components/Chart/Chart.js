            ...
            <GridItem xs={12} style={{ marginTop: "20px" }}>
              ...
              {projects.project.trainingMethod === "time_series_regression" ? (
                <div style={{ marginLeft: "40px" }}>
                  ...
                  <div>
                    Error Rate :{" "}
                    {t("Indicates the percentage of errors that occurred when sampling.")}{" "}
                    <a
                      href={
                ...
                <div style={{ marginLeft: "40px" }}>
                  <div>
                    Total Loss :{" "}
                    {t(
                      "이미지 생성(GAN) 에서의 Loss는 오토 파라미터의 구실을 하는 것이여서 이미지 유사도에 대한 평가지표가 되진 않습니다."
                    )}
                  </div>
                  <div>
                    Error Rate :{" "}
                  ...
                  <div>
                    Dice :{" "}
                    {t(
                      "실제 값과 예측 값의 유사성을 측정하기 위해 사용되는 샘플 계수입니다."
                    )}{" "}
                    <a
                      href={
          ...
          <div style={{ display: "flex", marginTop: "40px" }}>
            <div style={{ display: "flex", flexDirection: "column" }}>
              ...
              <div style={{ marginLeft: "40px" }}>
                Loss :{" "}
                {t(
                  "딥러닝 학습에 사용되는 손실 함수입니다. 학습이 진행 될수록 값이 낮아져야 좋은 모델이 생성됩니다."
                )}{" "}
                <a
            ...
            <div style={{ display: "flex", flexDirection: "column" }}>
              ...
              <div style={{ marginLeft: "40px" }}>
                <div>
                  Precision :{" "}
                  {t(
                    "예측 값이 참일 때 실제 값이 참인 비율입니다. 값이 1에 근접할 수록 좋은 모델이라고 볼 수 있습니다."
                  )}{" "}
                  <a
                    href={
                ...
                <div>
                  Recall :{" "}
                  {t(
                    "실제 값이 참일 때 예측 값이 참인 비율입니다. 값이 1에 근접할 수록 좋은 모델이라고 볼 수 있습니다."
                  )}{" "}
                  <a
                    href={
            ...
            <div style={{ display: "flex", flexDirection: "column" }}>
              ...
              <div style={{ marginLeft: "40px" }}>
                <div>
                  Kappa_score :{" "}
                  {t(
                    "모델 신뢰도를 측정하는데 사용되는 통계량입니다. 값이 1에 근접할 수록 모델의 신뢰도가 높습니다."
                  )}{" "}
                  <a
            ...
            <div style={{ display: "flex", flexDirection: "column" }}>
              ...
              <div style={{ marginLeft: "40px" }}>
                <div>
                  AUROC :{" "}
                  {t(
                    "FPR (False Positive Rate )에 대한 TPR (True Positive Rate) 을 플로팅하여 생성된 곡선의 면적 값을 계산합니다. 값이 1에 근접할 수록 모델의 신뢰도가 높습니다."
                  )}{" "}
                  <a
                    href={
