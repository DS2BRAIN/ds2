          ...
          <>
            ...
            <div style={{ marginBottom: "10px" }}>
              ...
              <div>
                ...
                {t(
                  "Categories and continuous values are automatically classified."
                )}{" "}
              </div>
              <div>
                - {t("Structured Data Category Classification")} :{" "}
                {t(
                  "Categories and similar non-continuous values are predicted."
                )}
              </div>
              <div>
                - {t("Structured Data Regression")} :{" "}
              ...
              <div>
                ...
                {t(
                  "We recommend products by analyzing the association between users."
                )}
              </div>
            </div>
            <div style={{ marginBottom: "10px" }}>
              ...
              <div>
                ...
                {t(
                  "Pre-labeling is required. Labeling can be done through object recognition labeling in the main menu."
                )}
              </div>
              {/* <div>
                - GAN :{" "}
        ...
        return (
          <>
            ...
            <div style={{ marginBottom: "20px" }}>
              ...
              <div>
                {t(
                  "Generate ready-to-run deep learning development code in Jupyter environment."
                )}
              </div>
            </div>
            <div style={{ marginBottom: "20px" }}>
              ...
              <div>
                {t(
                  "AI models with higher accuracy are prioritized when generating models."
                )}{" "}
            ...
            <div style={{ marginBottom: "20px" }}>
              ...
              <div>
                {t(
                  "Set and use your preferred machine learning/deep learning library and hyperparameter."
                )}
              </div>
            </div>
          </>
      ...
      case "trainingPriority":
        return (
          <>
            ...
            <div>
              {t(
                "Select whether or not you want to start training for this project first."
              )}
            </div>
          </>
        );
      case "isVerify":
        return (
          <>
            ...
            <div>
              {t(
                "Check whether to use more detailed data validation with the artificial intelligence created through the project."
              )}
            </div>
          </>
        );
        ...
        return (
          <>
            ...
            <div style={{ marginBottom: "20px" }}>
              <div>
                {t(
                  "To utilize a specific GPU, select and train with the desired GPU."
                )}
              </div>
            </div>
          </>
