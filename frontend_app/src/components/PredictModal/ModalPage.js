...
const ModalPage = React.memo(({ isStandard, closeModal, chosenItem, isMarket, opsId, csv, trainingColumnInfo, history, marketProjectId, isStandardMovie }) => {
  ...
  const dropFilesReject = () => {
    dispatch(openErrorSnackbarRequestAction(t("Invalid file type. Only .csv file can be uploaded")));
  };
        ...
        if (res.data.visionModel || res.data.objectDetectionModel) {
          api
            ...
            .then((blob) => {
              ...
              closeModal();
              dispatch(openSuccessSnackbarRequestAction(t("Successfully predicted.")));
            })
            .then(() => {
            ...
            .catch((e) => {
              ...
              const message = e.response ? (user.language === "ko" ? e.response.data.message : e.response.data.message_en) : t("Data error");
    ...
    if (chosenItem === "predict" || chosenItem === "autolabelling") {
      if (completed > 0 && isAPILoading) {
        ...
        if (isPredictAllSuccess) {
          return (
            <div className={classes.fileModalContainer} style={{ minHeight: "250px" }}>
              <CloseIcon className={classes.closeImg} onClick={closeModalAction} />
            ...
            <div className={classes.fileModalContainer} style={{ minHeight: "250px" }}>
              ...
              <div className={classes.predictContainer}>
                <div style={{ fontSize: "20px", marginTop: "20px" }}>
                  ...
                  <p className={classes.text} style={{ wordBreak: "break-all" }}>
          ...
          return (
            <div className={classes.fileModalContainer}>
              ...
              <div className={classes.predictAllContainer} id="predictModal">
                ...
                <Button
                  id="clickPredict"
                  className={files.length < 1 ? `${classes.defaultDisabledButton} ${classes.neoBtnH30}` : `${classes.defaultGreenOutlineButton} ${classes.neoBtnH30}`}
                  style={{
                    width: "240px",
                    alignSelf: "flex-end",
                    cursor: "default",
      ...
      return (
        <div className={classes.modalPredictContainer}>
          ...
          <div className={classes.apiContainer}>
            <API isStandard={isStandard} chosenItem={chosenItem} csv={csv} trainingColumnInfo={trainingColumnInfo} modelDetail={modelDetail} history={history} isMarket={isMarket} opsId={opsId} marketProjectId={marketProjectId} isStandardMovie={isStandardMovie} closeModal={closeModalAction} />
          </div>
        </div>
      );
    }
