...
import { AWS_REGION } from "../../TestJSON";
      ...
      {process.env.REACT_APP_ENTERPRISE !== "true" ? (
        <>
          ...
          >
            ...
            alignItems="center"
          >
            <img src={aws_logo} style={defaultStyles.img_flatform_disabled} />
            ...
            <a
              href={
                cloudName == "AWS"
                  ...
                  : "https://azure.microsoft.com/ko-kr/global-infrastructure/geographies/"
              }
              style={{ padding: "0px" }}
              target="_blanck"
            >
