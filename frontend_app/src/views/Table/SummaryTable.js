  ...
  ({
    ...
    const onSetSummaryCheckedValue = async (value) => {
      ...
      if (category === "sample") {
        dispatch(
          openErrorSnackbarRequestAction(
            t("You can’t make changes to 'Training data usage' when using sample data.")
          )
        );
        return;
      }
      ...
      if (value === projects.project.valueForPredictColumnId) {
        dispatch(
          openErrorSnackbarRequestAction(
            t(" Values ​​you want to analyze/predict cannot be used as training data.")
          )
        );
        return;
      }
    ...
    const setTimeSeriesCheckValueFunc = (value) => {
      ...
      if (!timeSeriesCheckedValue.hasOwnProperty(value)) {
        dispatch(
          openErrorSnackbarRequestAction(
            t("This column cannot be used as a reference for time series forecasting.")
          )
        );
        return;
      }
                  ...
                  <Tooltip
                    title={
                      <span style={{ fontSize: "12px" }}>
                        {t(
                          // "전처리는 데이터 클렌징, 정규화, 비식별화, 데이터 치환 총 네 종류가 있으며, 필요에 따라 선택하실 수 있습니다."
                          "전처리는 데이터 클렌징, 정규화, 데이터 치환 총 세 종류가 있으며, 필요에 따라 선택하실 수 있습니다."
                        )}
                      </span>
                    }
                    placement="right"
                              ...
                              >
                                ...
                                <Tooltip
                                  title={
                                    <span style={{ fontSize: "11px" }}>
                                      {t(
                                        "시계열 예측이란 시간의 흐름에 따라 변화하는 주어진 데이터를 학습시킴으로써 미래에 그 데이터가 어떤 값을 가질지 예측하는 인공지능 모델을 말합니다."
                                      )}
                                    </span>
                                  }
                                  placement="top"
                      ...
                      <FormControlLabel
                        ...
                        label={
                          ...
                          preprocessingInfo[
                            ...
                            ? t("Data cleansing")
                            : t(
                                "데이터 클렌징 : 전체 표준분포의 n% 이상을 벗어나는 행들을 삭제합니다."
                              )
                        }
                      />
                      {(preprocessingInfo[
                  ...
                  <FormControlLabel
                    ...
                    label={
                      ...
                      preprocessingInfo[
                        ...
                        : `${t("Remove outliers")} : ${t(
                            "유니크값이 전체 데이터 개수의 n% 이상을 차지하는 열을 삭제합니다."
                          )}`
                    }
                  />
                  {(preprocessingInfo[
                      ...
                      projects.project.trainingMethod.indexOf("time_series") >
                        ...
                        >
                          <FormControlLabel
                            ...
                            label={`${t("")} : ${t(
                              "시계열 통계값 변환시 합계값이 아닌 평균값으로 통계를 산출합니다."
                            )}`}
                          />
                        </GridItem>
                      )}
